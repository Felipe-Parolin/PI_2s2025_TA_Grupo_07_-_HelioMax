document.addEventListener("DOMContentLoaded", function () {
  ...
  function setupAnimations() {
    const formElements = document.querySelectorAll(
      ".form-group, .form-options, .login-button, .divider, .social-buttons, .signup-link"
    );
  ...
  function handleForgotPassword(e) {
    ...
    if (email && validateEmail()) {
      ...
      showNotification(
        "Por favor, insira um email válido primeiro.",
        "warning"
      );
      emailInput.focus();
    }
  ...
  function hideLoading() {
    ...
    loginButton.innerHTML =
      '<span class="button-text">Entrar</span><i class="fas fa-arrow-right button-icon"></i>';
  }
